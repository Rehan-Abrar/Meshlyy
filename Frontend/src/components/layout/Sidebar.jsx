...
const NAV_ITEMS = {
  brand: [
    ...
    { path: '/brand/search',       label: 'Discover' },
    { path: '/brand/shortlist',    label: 'Shortlist' },
    { path: '/brand/ai-assistant', label: 'AI Assistant' },
  ],
  influencer: [
    { path: '/influencer/dashboard',    label: 'Dashboard' },
    { path: '/influencer/campaigns',    label: 'Campaigns' },
    { path: '/influencer/invitations',  label: 'Invitations' },
    { path: '/influencer/ai-assistant', label: 'AI Assistant' },
  ],
  admin: [
  ...
  return (
    <>
      <div 
        ...
        aria-hidden="true" 
      />
      <aside className={`${styles.sidebar} ${isOpen ? styles.sidebarOpen : ''}`} aria-label="Main Sidebar Navigation">
